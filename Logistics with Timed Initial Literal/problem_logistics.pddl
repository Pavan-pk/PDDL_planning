...
(:requirements :strips :typing :durative-actions :numeric-fluents :timed-initial-literals)
    ...
    (:init
        ...
        (at 0 (can_deliver pack1))
        (at 0 (can_deliver pack2))
        (at 0 (can_deliver pack3))
        (at 0 (can_deliver pack4))
        
        (at 1571 (not (can_deliver pack1)))
        (at 1571 (not (can_deliver pack2)))
        (at 1571 (not (can_deliver pack3)))
        (at 1571 (not (can_deliver pack4)))
